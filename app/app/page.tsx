...
export default function AppPage() {
  ...
  return (
    <AuthProvider>
      ...
      <main className="flex min-h-screen flex-col items-center [padding-block:2rem] [padding-inline:1rem] sm:[padding-inline:1.5rem] lg:[padding-inline:2rem] bg-slate-50">
        {!isAuthenticated ? (
